...
(function initFilterSliderWithLabels() {
  ...
  Object.entries(filterList).forEach(([name, filter]) => {
    ...
    img.addEventListener("click", () => {
      ...
      const freshFilter = filter.clone
        ? filter.clone()
        : new filter.constructor(filter);
...
function checkUserSubscription() {
  ...
  if (
    subscriptionId &&
    subscriptionId !== "" &&
    !subscriptionId.startsWith("TEST-")
  ) {
    return true;
  }
...
function exportMedia() {
  ...
  if (format === "png" || format === "jpg") {
    ...
    if (!isSubscribed) {
      ...
      alert(
        "تصدير الفيديو متاح فقط للمشتركين. يرجى الاشتراك للوصول إلى هذه الميزة."
      );
      ...
      if (
        confirm(
          "هل ترغب في الاشتراك الآن للوصول إلى تصدير الفيديو والمزيد من الميزات؟"
        )
      ) {
